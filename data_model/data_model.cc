...
std::optional<ResourceClassPtr> DataModel::get_resource_class(const xsd::AnyUri &resource_class_id) const {
...
std::optional<ResourceClassPtr> DataModel::remove_resource_class(const xsd::AnyUri &resource_class_id) {
  //
...
std::optional<PropertyPtr> DataModel::get_property(const xsd::AnyUri &property_id) const {
...
std::optional<PropertyPtr> DataModel::remove_property(const xsd::AnyUri &property_id) {
  //
  // ToDo: Check here if data model is in use!!!
  //
  auto res = properties_.find(property_id);
