...
std::shared_ptr<Agent> Agent::Factory(const dsp::Shortname& shortname, ObserverPtr obs) {
...
std::shared_ptr<Agent> Agent::Factory(const nlohmann::json &json_obj, ObserverPtr obs) {
